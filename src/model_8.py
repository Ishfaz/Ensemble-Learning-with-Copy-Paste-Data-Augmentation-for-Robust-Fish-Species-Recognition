...
save_dir = "/cluster/home/ishfaqab/Saithes_prepared/results/orginal_8l_prep_data"
os.makedirs(save_dir, exist_ok=True)
model.info()
results = model.train(
    project=save_dir,
    name="run12m",
    data="/cluster/home/ishfaqab/Saithes_prepared/orginal_data/data.yaml", 
    epochs=300,
    imgsz=640,
    batch=32, 
    dropout=0.2,
...
print(f"\nResults are saved in: {os.path.join(save_dir, 'run12m')}")